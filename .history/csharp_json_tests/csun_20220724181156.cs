...
namespace csun
{
    ...
    public class csun
    {
        public static async Task Main()
        {
            ...
            using HttpClient client_spring = new() { BaseAddress = new Uri("https://api.metalab.csun.edu/curriculum/api/2.0/terms/Spring-2023/courses/comp") };
            ...
            List<Class1> complete_listing = fall_listing?.classes.Concat(spring_listing?.courses).ToList();
