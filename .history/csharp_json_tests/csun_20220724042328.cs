...
namespace csun
{
    ...
    public class course {
public string? class_number {get}
public string? subject {get}
public string? catalog_number {get}
public string? section_number {get}
public string? title {get}
public string? course_id {get}
public string? description {get}
public string? units {get}
public string? term {get}
public string? class_type {get}
public string? enrollment_cap {get}
public string? enrollment_count {get}
public string? waitlist_cap {get}
public string? waitlist_count {get}
