...
public class csun {public StringNormalizationExtensions asy{HttpClient client = new HttpClient();
...
course? classes = await JsonSerializer.Deserialize<course>(await stringTask);
