...
namespace csun
{
    ...
    public class course {
public sclass_number
public ssubject
public scatalog_number
public ssection_number
public stitle
public scourse_id
public sdescription
public sunits
public sterm
public sclass_type
public senrollment_cap
public senrollment_count
public swaitlist_cap
public swaitlist_count
public smeetings
    }
