...
namespace csun
{
    ...
    public class csun
    {
        ...
        section_string.Add("\t\t    " +
                              (c.meetings[0].start_time).Substring(0,1) + ":" +
                              (c.meetings[0].start_time).Substring(2,3)
                              + " - " +
                              (c.meetings[0].end_time).Substring(0,1) + ":" +
                              (c.meetings[0].end_time).Substring(2,3));
                }//end ML if

                foreach (string s in section_)
