...
namespace csun
{
    ...
    public class csun
    {
        public static async Task Main()
        {
            ...
            Rootobject? fall_listing = await client_fall.GetFromJsonAsync<Root?>(new string(""));
            Rootobject? spring_listing = await client_spring.GetFromJsonAsync<Root?>(new string(""));
