...
public class Instructor
{
    ...
    public class csun
    {
        ...
        {
            using HttpClient client_f = new (){BaseAddress = new Uri("https://api.metalab.csun.edu/curriculum/api/2.0/terms/Fall-2022/classes/math")};
            using HttpClient client_spring = new (){BaseAddress = new Uri("https://api.metalab.csun.edu/curriculum/api/2.0/terms/Fall-2022/classes/math")};
           ...
           // Classes? classes = await JsonSerializer.DeserializeAsync<Classes>(await stringTask);
            ...
            Rootobject? rtob = await client.GetFromJsonAsync<Rootobject?>(new string(""));
            Console.WriteLine(rtob?.api);
