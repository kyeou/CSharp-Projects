...
public class Instructor
{
    ...
    public class csun
    {
        ...
        {
            using ttpClient client = new HttpClient(BaseAddress = new Uri("https://api.metalab.csun.edu/curriculum/api/2.0/terms/Fall-2022/classes/math"));
           ...
           // Classes? classes = await JsonSerializer.DeserializeAsync<Classes>(await stringTask);
            ...
            Rootobject? rtob = await client.GetFromJsonAsync<Rootobject>(await stringTask);
